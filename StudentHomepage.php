...
if(($_SESSION['person_id'] == $_SESSION['userLogin'])&&($alumniInfo['alumni_type']== 'student alumni'))
{
...
//$query_a="SELECT * FROM `university_alumni`.`alumni` where person_id=$_SESSION['person_id']";
//$alumniInfo=mysqli_query($conn, $query_a);
//$query_o="SELECT * FROM student_alumni where person_id=$_SESSION['person_id']";
//$otherInfo=mysqli_query($conn, $query_o);
	...
	<div class="body">
		<div class="donate">
			...
			<div>
					...
					<hr></hr>
    <?php if ($alumniInfo['alumni_type'] == 'student alumni') 
        {  ?> 
                ...
                <label class="contentLabel">Grad Year:  </label><input type="text" name="gradyear" value="<?php echo $otherInfo['grad_year']; ?>" /> <br />
                <label class="contentLabel">Major Advisor :  </label><input type="text" name="majoradv" value="<?php echo $otherInfo['major_advisor']; ?>" /> <br />
                <label class="contentLabel">Major Department :  </label><input type="text" name="majordept" value="<?php echo $otherInfo['major_dept']; ?>" /> <br />
                <label class="contentLabel">Awards :  </label><input type="text" name="awards" value="<?php echo $otherInfo['awards']; ?>" /> <br />
                </table>
				<br />
				<br />
